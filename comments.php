            ...
            <?php else: ?>
                <div id="form-user" class="form__user<?php if ($this->remember('author', true)): ?> form__user__hide<?php endif; ?>">
                    <div class="form__input">
                        <input type="text" name="author" class="text" placeholder="Name *" value="<?php $this->remember('author'); ?>" tabindex="2">
                    </div>
                    <div class="form__input form__clear">
                        <input type="email" name="mail" class="text" placeholder="i@url.cn *" value="<?php $this->remember('mail'); ?>" tabindex="3">
                    </div>
                    <div class="form__input">
                        <input type="url" name="url" class="text" placeholder="http://url.cn" value="<?php $this->remember('url'); ?>" tabindex="4">
                    </div>
                </div>
